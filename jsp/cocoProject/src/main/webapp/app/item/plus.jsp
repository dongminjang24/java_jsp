                ...
                <form action="${pageContext.request.contextPath}/item/writeOk.it" class="frm_selling_goods" name="writeForm"  method="post" enctype="multipart/form-data">
                    ...
                    <div class="goods_price_area">
                        ...
                        <div class="goods_price">
                            ...
                            <input type="hidden" name="shippingPrice" value="false">
                        ...
                        <div class="goods_option_area">
                            ...
                            <div class="goods_option">
                                <div class="checkbox_safePay">
                                    <input type="checkbox" name="protectedPayment" id="protectedPayment"  value="true">
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            for(let sub2Category of response) {
            	sub2CategoryHtml += '<div id='+ sub2Category.subCategory2Id +'>' + sub2Category.name + '</div>';
                console.log(sub2Category.subCategory2Id)
            }
...
$(document).on('click', '.goods_Scategory_cloth div', function() {
    ...
    const selectedId = $(this).attr('id'); // 클릭한 div의 ID 값을 가져옵니다.
	console.log(selectedId)
    $('.selected_sub2_category').text(selectedSub2Category);
    $('#subCategory2Id').val(selectedId);
...
<script src="${pageContext.request.contextPath}/assets/js/goods/goods_selling_form.js" defer></script>
