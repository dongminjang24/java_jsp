		...
		<div class="wrapper">
			<div class="inner">
				...
				<section class="main">
					...
					<hr>
					<form method="post" action="${pageContext.request.contextPath}/member/joinOk.me" name="joinForm" id="">
						<div style="display:flex; justify-content:space-around;">
							<div style="width:40%;">
								...
								<input type="email" name="memberEmail" id="memberEmail" value="">
								<br>
							...
							<div class="preview" style="width:40%;">
								...
								<div>
									<h4>광고2</h4>
									<img src="${pageContext.request.contextPath}/assets/images/ex02.png" >
								</div>
								<hr>
								<div>
									<h4>광고3</h4>
